...
from cookiecutter_starter.users.models import User
from cookiecutter_starter.users.tests.factories import UserFactory
from cookiecutter_starter.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
